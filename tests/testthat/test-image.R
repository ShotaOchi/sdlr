test_that("image",
{
  ...
  expect_no_error(pick(human, mark = FALSE))
  expect_no_error(pick(human, mark = FALSE, type = "line"))
  expect_no_error(pick(human, mark = FALSE, type = "rect"))
  expect_no_error(pick(human, size = 1))
  expect_no_error(pick(human, size = 1, type = "line"))
  expect_no_error(pick(human, size = 1, type = "rect"))
  ...
  expect_error(pick(human, size = c(100,100)))
  expect_error(pick(human, size = 0))
  expect_error(pick(human, size = "vdsasda"))
